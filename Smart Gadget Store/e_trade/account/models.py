...
class User(AbstractUser):
    ...
    phone_regex = RegexValidator(
        regex=r'^\+?01\d{9}$',  # Phone number must start with '01' and be followed by 9 digits
        message="Phone number must be entered in the format: '01*********'. Up to 11 digits allowed. Phone number must be a valid Bangladeshi number."
    )
